...
namespace LiveDinner.Controllers
{
    public class ReportsController : Controller
    {
        ...
        public ActionResult PurchaseReport(FilterModel filterModel)
        {
            ...
            var sr = db.Orders.Where(s => s.Order_Type == "Purchase" & s.Order_Date_Time >= filterModel.DateFrom & s.Order_Date_Time <= filterModel.DateTo & od.Contains(s.Order_Id)).OrderByDescending(x => x.Order_Id).ToList();
            return View(sr);
        }
